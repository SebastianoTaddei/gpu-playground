...
void benchmark_mat_add(DevicePtr const &device, Tensor &a, Tensor &b)
...
int main()
{
  ...
  benchmark_mat_add(serial_device, a, b);
  benchmark_mat_add(eigen_device, a, b);
  benchmark_mat_add(simd_device, a, b);
  benchmark_mat_add(metal_device, a, b);
