...
void benchmark_mat_sub(DevicePtr const &device, Tensor &a, Tensor &b)
...
int main()
{
  ...
  benchmark_mat_sub(serial_device, a, b);
  benchmark_mat_sub(eigen_device, a, b);
  benchmark_mat_sub(simd_device, a, b);
  benchmark_mat_sub(metal_device, a, b);
